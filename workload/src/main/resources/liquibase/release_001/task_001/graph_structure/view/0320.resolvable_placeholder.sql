...
from a
    left join DICT_PLACE_HOLDER_BY_SERVICE ph_srv on (ph_srv.SERVICE_ID, ph_srv.PROFILE_ID, ph_srv.STAND_ID) = ((a.SERVICE_ID, a.PROFILE_ID ,a.stand))
/
comment on view resolvable_placeholder is 'Разрешенне значения пленйсхолдеров.'
/
